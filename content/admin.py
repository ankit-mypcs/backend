...
class SubjectAdmin(admin.ModelAdmin):
    list_display = ['name', 'name_hi', 'category', 'is_active', 'order']
...
class ChapterAdmin(admin.ModelAdmin):
    ...
    search_fields = ['title', 'title_hi', 'code']
...
class QuestionAdmin(admin.ModelAdmin):
    ...
    search_fields = ['question_id', 'stem', 'stem_hi']
...
class KeyTermAdmin(admin.ModelAdmin):
    list_display = ['term', 'term_hi', 'subject']
    list_filter = ['subject']
    search_fields = ['term', 'term_hi', 'definition', 'definition_hi']
